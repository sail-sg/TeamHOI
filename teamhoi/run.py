...
from learning import amp_agent_multi as amp_agent
#from learning import amp_agent as amp_agent
from learning import amp_players
from learning import amp_models
from learning import amp_network_builder

from learning.transformer import teamhoi_transformer
...
def build_alg_runner(algo_observer):
    ...
    runner.model_builder.network_factory.register_builder('teamhoi_transformer', lambda **kwargs : teamhoi_transformer.AMPTransformerMultiTaskBuilder())
    return runner
...
def main():
    ...
    if args.motion_file2:
        cfg['env']['motion_file2'] = args.motion_file2
    ...
    if args.wandb_name == "NoName":
        os.environ["WANDB_MODE"] = "disabled"

    wandb.init(project="teamhoi", name=args.wandb_name)
    ...
    wandb.config.motion_file2 = args.motion_file2
